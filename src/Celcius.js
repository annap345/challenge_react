...
if (def === "C") {
    return (<div>
        <h2 class="degree"><span id="main-degree">{Math.round(props.temp)} </span>°C /<a id="fahrenheit" href="/" onClick={fahr}>°F</a></h2>
    ...
    return (<div>
        <h2 class="degree"><span id="main-degree">{setFahr} </span><a href="/" onClick={cel}>°C </a>/°F</h2>
